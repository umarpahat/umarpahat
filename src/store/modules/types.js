...
export const USERAPPUSECASE = 'USERAPPUSECASE'
export const HITAPPUSECASE = 'HITAPPUSECASE'
export const HITPAYRENTINFO = 'HITPAYRENTINFO'
export const HITPAYRENTINFOAPI = 'HITPAYRENTINFOAPI'
export const STOREPAYRENTDATA = 'STOREPAYRENTDATA'
