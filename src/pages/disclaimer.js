                ...
                <div className="container">
                    <div className="row align-items-center p-t-40 p-b-30">
                        <div className="col-lg-12  col-md-12  col-sm-12 col-xs-12 textAlign paragraphText">
                            ...
                            <ol type="a">
                                <li>you acknowledge PayMeindia web pages as the source of the material. You must include such acknowledgement and Batchelors Solicitors web address ( <a href="https://www.paymeindia.in/">http://www.PayMeindia.in</a>) in the copy of the material; and
                                </li>
                                <li>you inform the third party that these conditions apply to him or her and that he or she must comply with them. This licence to recopy does not permit incorporation of the material or any part of it in any other work or publication, whether in hard copy or electronic or any other form. In particular (but without limitation) no part of the PayMeindia web pages may be distributed or copied for any commercial purpose.</li>
                            </ol>
