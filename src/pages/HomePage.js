        ...
        <div className="carousel-item active">
            <div className="container">
                <div className="row align-items-center pb-3">
                    <div className="col col-md-6 p-t-40"><img className="img-fluid" alt="CIBIL" src={CibilImg}/></div>
                    <div className="col col-md-6">
                        <div className="p-l-30">
                            <h3 className="heading3"><span className="col-sky">CIBIL</span> Score & Report</h3>
                            <h3 className="heading3"><span className="col-orange">ABSOLUTELY FREE </span></h3>
                            <a href="#" className="button-large m-t-40">Get CIBIL report</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="carousel-item black-bg p-b-30">
            <div className="container">
                <div className="row align-items-center pb-3 text-center">
                    ...
                    <img className="img-fluid" alt="CIBIL" src={saltlogo}/>
                    </div>
                    <div className="col col-md-12">
                        <h3 className="heading2 p-t-20 animate__animated animate__slideInDown white-color">Use as much as
                            you need
                        </h3>
                        <a href="#" className="button-blue m-t-40 animate__animated animate__slideInUp">Know More</a>
                    </div>
                </div>
            </div>
        </div>
...
<div className="banner">
    <div className="container">
        <div className="row align-items-center">
            <div className="col col-md-6 col-sd-6 col-xd-12">
                ...
                <p className="para-13">No more financial crunch. Payme India gives you the amount of loan you require,
                    anytime-anywhere</p>
                {/* <div className="clearfix">
                    <a href="#" className="button-gray"><img alt="CIBIL" src="images/ios.png"/> Google Play
                    </a>
                    <a href="#" className="button-gray"><img alt="CIBIL" src="images/android.png"/> App Store</a>
                </div> */}
            </div>
            <div className="col col-md-6 col-sd-6 col-xd-12 m-t-40">
                    ...
                    <form className="form-horizontal form-pricing" role="form">
                        ...
                        <div className="price-form">
                            <div className="form-group1">
                                <label htmlFor="total" className="col-sm-12 control-label">TOTAL AMOUNT &#8377;</label>
                            ...
                            <div className="form-group1">
                                <label htmlFor="duration" className="col-sm-12 control-label">INTEREST &#8377;</label>
                                <div className="col-sm-12">
                            ...
                            <div className="form-group1">
                                <label htmlFor="amount" className="col-sm-12 control-label">REPAYMENT &#8377; </label>
                                <div className="col-sm-12">
                      ...
                      props.history.push({pathname: '/apply-loan'})
                            ...
                            <a href="#" className="button-gray">Apply Loan</a>
                            </Link>
                            </div>
                        </div>
                    </form>
...
<div className="loan-features">
    <div className="container">
        ...
        <div className="row align-items-center">
            <div className="col col-md-6">
                <div className="farmer text-center"><img src={appIcon} className="farmer-img" alt="app"/></div>
            </div>
            <div className="col col-md-6">
                <div className="row">
                    <div className="col col-md-6 ">
    ...
    <div className="owl-carousel owl-theme">
        <div className="item first prev text-left">
            <div className="card  py-3 px-4">
                <div className="">
                    <div className="profile-pic float-left"><img src={userIcon} className="img-fluid"/></div>
                    <h6>Aghilesh Nair</h6>
                    <span>(Bengaluru)</span>
                </div>
                <p className="content mb-5 mx-2 pt-3">Now That's what I call a Service... Ignoring the fact that there were
        ...
        <div className="item show text-left">
            <div className="card  py-3 px-4">
                ...
                <p className="content mb-5 mx-2 pt-3">Excellent service Best service ever. I needed some money for medical
        ...
        <div className="item next text-left">
            <div className="card  py-3 px-4">
                ...
                <p className="content mb-5 mx-2 pt-3">Needed moneyy It was a miracle for me that Payme India approved my
        ...
        <div className="item next text-left">
            <div className="card  py-3 px-4">
                ...
                <p className="content mb-5 mx-2 pt-3">Quick and easy service to fulfill short term cash needs, I got my
        ...
        <div className="item last text-left">
            <div className="card  py-3 px-4">
                ...
                <p className="content mb-5 mx-2 pt-3">Very fast service If anyone in urgently need in money then dont waste
...
<div className="float-full how-it-works">
    <div className="container">
        <div className="row align-items-center">
            ...
            <div className="row">
                <div className="col col-md-4 home-steps"><img className="icon" src={register}
                ...
                <div className="col col-md-4 home-steps"><img className="icon" src={uploadImg}
                ...
                <div className="col col-md-4 home-steps"><img className="icon" src={eligibilityImg} alt="Check Eligibility"/>
                    <div className="home-steps-in">
            ...
            <div className="row">
                <div className="col col-md-4 home-steps"><img className="icon" src={promptImg}  alt="Prompt Verification"/>
                    <div className="red-arrow hidden-xs"></div>
                    <div className="red-arrow-bottom hidden-xs"></div>
                    <div className="home-steps-in">
                ...
                <div className="col col-md-4 home-steps"><img className="icon" src={instantFund} alt="instant"/>
                    <div className="red-arrow hidden-xs"></div>
                    <div className="red-arrow-bottom hidden-xs"></div>
                    <div className="home-steps-in">
                ...
                <div className="col col-md-4 home-steps"><img className="icon" src={easyRepay} alt="easy-repay"/>
                    <div className="home-steps-in">
