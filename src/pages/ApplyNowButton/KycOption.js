                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-12 text-center">
                        <div className="home-contact-form">
                          <img src={S3_IMAGES_URL+'/animated/success-animation.gif'} className='img-fluid max-width70'  alt='Icon'/>
                      ...
                      <div>
                        <div className="circle-half">
                          <div className="full-circle">
                            <img src={S3_IMAGES_URL+'/svg/tip.png'}  className="img-fluid" alt="Tips" />
                          </div>
