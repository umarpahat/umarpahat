  ...
  return (
          ...
          <div className="row">
            ...
            <div className="col-lg-5 col-md-5 col-sm-12 text-center">
              ...
              <div className="home-contact-form">
                <div className="text-center p-b-30"><img src={S3_IMAGES_URL+'/svg/img.png'} alt='Icon' className='img-fluid' style={{maxWidth:40}} /></div>

                <h4 className="form-heading formheadding pb-3">
                  Get Started With PayMe India
                </h4>
                <div className="text-center"><img src={S3_IMAGES_URL+'/animated/user-hexagon.gif'} alt='Icon' className='img-fluid' style={{maxWidth:200}} /></div>
    ...
    render={renderProps => (
      <button onClick={()=>{
        ...
        "padding": "5px 20px",
        "borderRadius": 8,
      cursor:"pointer"}} disabled={renderProps.disabled}> <img src={S3_IMAGES_URL+'/googleimg.png'} alt="google"/> Sign Up with Google</button>
    )}
                ...
                <div>
                  <div className='circle-half'>
                    <div className='full-circle'>
                      <img src={S3_IMAGES_URL+'/animated/lets-start-animation.gif'} alt='Icon' className='img-fluid' style={{maxWidth:100}} />
                    </div>
