                          ...
                          <div className="step">
                            <div className="step-step">
                              <div className="img-wrapper">
                                <img
                                  className="img-fluid"
                                  src={S3_IMAGES_URL+'/svg/complete-kyc.svg'}
                                  alt="Icon"
                                />
                              </div>
                            ...
                            <div className="step-step">
                              <div className="img-wrapper">
                                <img
                                  className="img-fluid"
                                  src={S3_IMAGES_URL+'/svg/bank-details.svg'}
                                  alt="Icon"
                                />
                              </div>
                              <div className="img-text">
                      ...
                      <div>
                        <div className="circle-half">
                          <div className="full-circle">
                            <img src={S3_IMAGES_URL+'/svg/tip.png'} className="img-fluid"  style={{maxWidth:100}}  alt="Tips" />
                          </div>
