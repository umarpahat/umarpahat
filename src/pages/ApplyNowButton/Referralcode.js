...
function Referralcode(props) {
  ...
  const handleSubmit = (event) => {
    ...
    referral.length
      ? handleReferral()
      : seterror("Please enter valid referral code or press skip");
  };
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="home-contact-form mt-4">
                        ...
                        <div className="form-group ms-input-group">
                          ...
                          >
                            <img
                              src={S3_IMAGES_URL+'/Referral.png'}
                              alt="Referral"
                  ...
                  <div>
                    <div className="circle-half">
                      <div className="full-circle">
                        <img src={S3_IMAGES_URL+'/svg/tip.png'}  alt="Icon" />
                      </div>
                      <div className="full-text text-left">
                        <h5>Tips</h5>
                        <p style={{fontSize:"15px"}}>
                          Refer the PayMe India app with your friends & get cash
                          rewards of INR 200 directly in your account{" "}
                        </p>
                      </div>
                    </div>
                    <div className="circle-half">
                      <p className="p-a-10" style={{fontSize:"15px"}}>
                        Get extra reward directly in bank your account on each successful refferal.{" "}
                      </p>
                    </div>
                  </div>
                </div>
