                  ...
                  <div className="home-contact-form">
                    ...
                    <div className="form-block">
                      ...
                      <div className="row">
                       ...
                       {correctPan ? (
                                <img className='yes-icon_kyc' alt='Yes icons' src={S3_IMAGES_URL+'/yes.png'} />
                            ) : null}
                      ...
                      <div className="step-step p-t-50 border-btm">
                        <div className="img-wrapper">
                          <img
                            className="img-fluid"
                            src={S3_IMAGES_URL+'/svg/aadhaar-card.svg'}
                      ...
                      <div className="step-step p-t-30 border-btm">
                        <div className="img-wrapper">
                          <img
                            className="img-fluid"
                            src={S3_IMAGES_URL+'/svg/pan-card.svg'}
                            alt="Upload Pan Card"
                          />
                        </div>
                        <div className="img-text">
                      ...
                      <div className="step-step p-t-30 border-btm">
                        <div className="img-wrapper">
                          <img
                            className="img-fluid"
                            src={S3_IMAGES_URL+'/svg/selfie.svg'}
                            alt="Upload Selfie"
                          />
                        </div>
                        <div className="img-text">
                ...
                <div className="height100" style={{ height: "100vh" }}>
                  <div>
                    ...
                    >
                      ...
                      >
                        <img src={S3_IMAGES_URL+'/svg/tip.png'}  className="img-fluid" alt="Icon" />
                      </div>
                      <div
