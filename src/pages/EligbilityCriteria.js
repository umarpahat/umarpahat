                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-12 col-md-5 m-t-40">
                            ...
                            <p className="heading6">Consequatur quod quam. Tempore ipsam delectus ipsam voluptates
                                voluptate dolorem hic rerum recusandae. Quod dolores non vero cum reprehenderit.
                                Doloremque perspiciatis placeat consequatur.</p>
                            <br/>
                            <br/>
