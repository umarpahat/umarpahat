...
import {API_ENDPOINT_STAGING, API_ENDPOINT, S3_IMAGES_URL} from "../../constant";
                          ...
                          {RentAmount > 15000 && (
                            <div>
                              <div className="form-group ms-input-group">
                                ...
                                {correctPan ? (
                                <img className='yes-icon_payrent' alt='Yes icons' src={S3_IMAGES_URL+'/yes.png'} />
                            ) : null}
                              </div>
                              <div className="step-step p-t-30 border-btm">
                                <div className="img-wrapper">
                                  <img
                                    className="img-fluid"
                                    src={S3_IMAGES_URL+'/svg/professional-details.svg'}
                                    alt="Upload"
                                  />
                                </div>
