                        ...
                        <div className="row align-items-center p-b-30">
                            ...
                            <div className="row">
                                ...
                                <div className="col col-md-7">
                                    <h5 className='blue-color h3 p-t-20'>PayMe India launches project ‘Saarthi’ to support families impacted by Coivd-19,
                                        through skill building and creation of employment opportunities.</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col col-md-12">
                                    ...
                                    <p className='p-t-15'>While PayMe India appreciates the relief measures extended by
                                        state and central governments, which has indeed provided immediate support to
                                        the
                                        ...
                                        role, by empowering people with necessary skill set to increase their
                                        employability
                            ...
                            <div className="row">
                                ...
                                <div className="col col-md-7">
                                    <p className='p-t-15'>Through project ‘Saarthi’, PayMe India will provide free of
                                        cost
                                        skill development training to one member from each beleaguered family and
                                        further
                                        assist them in securing work opportunities. PayMe India have themselves pledged
                                        to
                                        directly employ people from this program.</p>
                                    <p className='p-t-15 p-b-30'>Driven by strong social values and a pledge to give
                                        back to
                                        the society, PayMe India is determined be a forerunner in supporting the nation
                                        through these testing times. Project ‘Saarthi’ will surely bring hope and relief
                                        to
                                        numerous families!</p>
